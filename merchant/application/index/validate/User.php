...
class User extends Validate
{
    ...
    protected $rule=[
        ...
        'reverify'   => 'require|number|length:6',
        'password'   => 'require|length:6,20',
        'repassword' => 'require|confirm:password',
        'industry'   => 'chsAlphaNum',
        'project'    => 'chsAlphaNum',
        'paypassword'=> 'require|number|length:6',
        'repaypassword'=> 'require|confirm:paypassword',
    ];
    protected $message=[
        ...
        "reverify.require"             =>"验证码必须",
        "reverify.number"              =>"验证码必须是数字",
        "reverify.length"              =>"验证码必须是6位",
        "password.require"             =>"登录密码必须",
        "password.length"              =>"登录密码格式错误",
        'repassword'                   =>'两次输入密码不一致',
        'repaypassword'                =>'两次输入支付密码不一致',
